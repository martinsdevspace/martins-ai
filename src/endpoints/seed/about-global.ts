...
export const aboutGlobal = (): Partial<DataFromGlobalSlug<'about'>> => ({
  heroHeadline: 'The builder behind the build.',
  intro: lexical(
    para(
  ...
  timeline: [
    { year: '2026', title: 'Agentic systems at scale', description: 'Shipping production AI agents for fintech and support.' },
    { year: '2024', title: 'Payments platform lead', description: 'Owned ledger and payout systems processing millions of transactions.' },
    { year: '2022', title: 'Full-stack contractor', description: 'Built products for startups across Africa and Europe.' },
    { year: '2020', title: 'First production system', description: 'A payment integration that has not stopped running since.' },
  ],
  skillsHeading: 'SKILLS',
  skillCategories: [
    { name: 'Frontend', tools: 'React · Next.js · TypeScript · Tailwind · Payload CMS', context: 'Production-first interfaces' },
    { name: 'Backend', tools: 'Node.js · Go · PostgreSQL · Redis · GraphQL · REST', context: 'APIs that hold up under load' },
    { name: 'AI / Agents', tools: 'Mastra · OpenAI · Anthropic · RAG · Evals', context: 'Agents that survive production' },
    { name: 'Infrastructure', tools: 'AWS · Docker · Kubernetes · Terraform · GitHub Actions', context: 'Deployments that don’t scare anyone' },
    { name: 'Payments', tools: 'Stripe · Paystack · Flutterwave · Ledger design', context: 'Money movement done right' },
    { name: 'Data', tools: 'ClickHouse · Kafka · dbt · OpenTelemetry', context: 'Pipelines that never lose an event' },
  ],
  speakingHeading: 'SPEAKING',
  beyondCodeHeading: 'Beyond the code.',
  beyondCode: [
    {
      paragraph:
  ...
  speaking: [
    { event: 'AgentConf', title: 'Evaluating agents before they reach production', year: '2026', location: 'Lagos, NG' },
    { event: 'Payments Summit', title: 'Ledgers that never lie', year: '2025', location: 'Nairobi, KE' },
  ],
