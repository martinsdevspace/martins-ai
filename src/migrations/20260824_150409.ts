...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__leads_v_version_source" AS ENUM('chat', 'contact-form', 'other');
  CREATE TYPE "public"."enum__leads_v_version_status" AS ENUM('new', 'contacted', 'closed');
  ...
  CREATE TABLE "leads" (
  	...
  	"source" "enum_leads_source" DEFAULT 'chat',
  ...
  CREATE TABLE "_leads_v" (
  	...
  	"version_source" "enum__leads_v_version_source" DEFAULT 'chat',
  ...
  CREATE TABLE "_comments_v" (
  	...
  	"version_author" varchar NOT NULL,
  	"version_email" varchar NOT NULL,
  ...
  CREATE TABLE "site_settings_terminal_lines" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"prompt" varchar,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"contact_intro" jsonb,
  	"footer_note" varchar,
  	"navigate_label" varchar,
  	"connect_label" varchar,
  	"contact_column_label" varchar,
  	"response_time_note" varchar,
  	"timezone_note" varchar,
  ...
  CREATE TABLE "about_blocks_about_hero_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"value" varchar,
  ...
  CREATE TABLE "about_blocks_about_hero" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "about_blocks_origin_story" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'Where it started',
  	"content" jsonb,
  	"block_name" varchar
  );
  
  CREATE TABLE "about_blocks_philosophy_values" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE "about_blocks_philosophy" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'How I think',
  	"intro" jsonb,
  	"block_name" varchar
  );
  
  CREATE TABLE "about_blocks_timeline_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"year" varchar,
  ...
  CREATE TABLE "about_blocks_timeline" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'The road so far',
  	"block_name" varchar
  );
  
  CREATE TABLE "about_blocks_skills_categories" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "about_blocks_skills" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'The stack',
  	"block_name" varchar
  );
  
  CREATE TABLE "about_blocks_beyond_code_paragraphs" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"paragraph" varchar
  ...
  CREATE TABLE "about_blocks_beyond_code" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'Beyond the code',
  	"block_name" varchar
  );
  
  CREATE TABLE "about_blocks_certifications_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "about_blocks_certifications" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'Credentials',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "home_blocks_home_hero" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "home_blocks_pain_points_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE "home_blocks_pain_points" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// THE_OLD_WAY',
  	"heading" varchar DEFAULT 'Stop fighting your stack.',
  	"intro" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "home_blocks_mini_stack_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tech" varchar
  ...
  CREATE TABLE "home_blocks_mini_stack" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// CURRENT_STACK',
  	"heading" varchar DEFAULT 'Built on a stack that ships.',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "home_blocks_about" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// — ABOUT',
  	"link_label" varchar DEFAULT 'READ_THE_FULL_STORY',
  	"block_name" varchar
  );
  
  CREATE TABLE "home_blocks_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// 02 — SELECTED_WORKS',
  	"heading" varchar DEFAULT 'Systems that run real money.',
  	"intro" varchar,
  	"view_all_label" varchar DEFAULT 'View all works',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "home_blocks_services" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// 03 — SERVICES',
  	"heading" varchar DEFAULT 'Engagements that ship.',
  	"intro" varchar,
  	"view_all_label" varchar DEFAULT 'View all services',
  	"block_name" varchar
  );
  
  CREATE TABLE "home_blocks_industries" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// 04 — INDUSTRIES',
  	"heading" varchar DEFAULT 'Where I operate.',
  	"intro" varchar,
  	"view_all_label" varchar DEFAULT 'View all industries',
  	"block_name" varchar
  );
  
  CREATE TABLE "home_blocks_process_phases_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tag" varchar
  ...
  CREATE TABLE "home_blocks_process_phases" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"num" varchar,
  ...
  CREATE TABLE "home_blocks_process" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// 06 — PROCESS',
  	"heading" varchar DEFAULT 'A repeatable path from first call to shipped.',
  	"intro" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "home_blocks_testimonials" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// 07 — TESTIMONIALS',
  	"heading" varchar DEFAULT 'What founders and engineering leads say.',
  	"intro" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "home_blocks_insights" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT '// 08 — LATEST_INSIGHTS',
  	"heading" varchar DEFAULT 'Notes from the build log.',
  	"intro" varchar,
  	"view_all_label" varchar DEFAULT 'View all insights',
  	"block_name" varchar
  );
  
  CREATE TABLE "home_blocks_page_cta" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "comments" ADD CONSTRAINT "comments_insight_id_insights_id_fk" FOREIGN KEY ("insight_id") REFERENCES "public"."insights"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_comments_v" ADD CONSTRAINT "_comments_v_version_insight_id_insights_id_fk" FOREIGN KEY ("version_insight_id") REFERENCES "public"."insights"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_settings_terminal_lines" ADD CONSTRAINT "site_settings_terminal_lines_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "about_blocks_about_hero_stats" ADD CONSTRAINT "about_blocks_about_hero_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_blocks_about_hero"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_about_hero" ADD CONSTRAINT "about_blocks_about_hero_portrait_id_media_id_fk" FOREIGN KEY ("portrait_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "about_blocks_about_hero" ADD CONSTRAINT "about_blocks_about_hero_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_origin_story" ADD CONSTRAINT "about_blocks_origin_story_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_philosophy_values" ADD CONSTRAINT "about_blocks_philosophy_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_blocks_philosophy"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_philosophy" ADD CONSTRAINT "about_blocks_philosophy_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_timeline_items" ADD CONSTRAINT "about_blocks_timeline_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_blocks_timeline"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_timeline" ADD CONSTRAINT "about_blocks_timeline_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_skills_categories" ADD CONSTRAINT "about_blocks_skills_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_blocks_skills"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_skills" ADD CONSTRAINT "about_blocks_skills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_beyond_code_paragraphs" ADD CONSTRAINT "about_blocks_beyond_code_paragraphs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_blocks_beyond_code"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_beyond_code" ADD CONSTRAINT "about_blocks_beyond_code_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_certifications_items" ADD CONSTRAINT "about_blocks_certifications_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about_blocks_certifications"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "about_blocks_certifications" ADD CONSTRAINT "about_blocks_certifications_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."about"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_home_hero" ADD CONSTRAINT "home_blocks_home_hero_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_pain_points_items" ADD CONSTRAINT "home_blocks_pain_points_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home_blocks_pain_points"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_pain_points" ADD CONSTRAINT "home_blocks_pain_points_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_mini_stack_items" ADD CONSTRAINT "home_blocks_mini_stack_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home_blocks_mini_stack"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_mini_stack" ADD CONSTRAINT "home_blocks_mini_stack_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_blocks_works" ADD CONSTRAINT "home_blocks_works_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_blocks_industries" ADD CONSTRAINT "home_blocks_industries_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_process_phases_tags" ADD CONSTRAINT "home_blocks_process_phases_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home_blocks_process_phases"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_process_phases" ADD CONSTRAINT "home_blocks_process_phases_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home_blocks_process"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_process" ADD CONSTRAINT "home_blocks_process_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home_blocks_insights" ADD CONSTRAINT "home_blocks_insights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "home_blocks_page_cta" ADD CONSTRAINT "home_blocks_page_cta_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."home"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "speaking_talks" ADD CONSTRAINT "speaking_talks_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."speaking"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "comments_insight_idx" ON "comments" USING btree ("insight_id");
  ...
  CREATE INDEX "_comments_v_version_version_insight_idx" ON "_comments_v" USING btree ("version_insight_id");
  CREATE INDEX "_comments_v_version_version_approved_idx" ON "_comments_v" USING btree ("version_approved");
  ...
  CREATE INDEX "site_settings_terminal_lines_order_idx" ON "site_settings_terminal_lines" USING btree ("_order");
  CREATE INDEX "site_settings_terminal_lines_parent_id_idx" ON "site_settings_terminal_lines" USING btree ("_parent_id");
  ...
  CREATE INDEX "about_blocks_about_hero_stats_order_idx" ON "about_blocks_about_hero_stats" USING btree ("_order");
  CREATE INDEX "about_blocks_about_hero_stats_parent_id_idx" ON "about_blocks_about_hero_stats" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_about_hero_order_idx" ON "about_blocks_about_hero" USING btree ("_order");
  CREATE INDEX "about_blocks_about_hero_parent_id_idx" ON "about_blocks_about_hero" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_about_hero_path_idx" ON "about_blocks_about_hero" USING btree ("_path");
  CREATE INDEX "about_blocks_about_hero_portrait_idx" ON "about_blocks_about_hero" USING btree ("portrait_id");
  CREATE INDEX "about_blocks_origin_story_order_idx" ON "about_blocks_origin_story" USING btree ("_order");
  CREATE INDEX "about_blocks_origin_story_parent_id_idx" ON "about_blocks_origin_story" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_origin_story_path_idx" ON "about_blocks_origin_story" USING btree ("_path");
  CREATE INDEX "about_blocks_philosophy_values_order_idx" ON "about_blocks_philosophy_values" USING btree ("_order");
  CREATE INDEX "about_blocks_philosophy_values_parent_id_idx" ON "about_blocks_philosophy_values" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_philosophy_order_idx" ON "about_blocks_philosophy" USING btree ("_order");
  CREATE INDEX "about_blocks_philosophy_parent_id_idx" ON "about_blocks_philosophy" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_philosophy_path_idx" ON "about_blocks_philosophy" USING btree ("_path");
  CREATE INDEX "about_blocks_timeline_items_order_idx" ON "about_blocks_timeline_items" USING btree ("_order");
  CREATE INDEX "about_blocks_timeline_items_parent_id_idx" ON "about_blocks_timeline_items" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_timeline_order_idx" ON "about_blocks_timeline" USING btree ("_order");
  CREATE INDEX "about_blocks_timeline_parent_id_idx" ON "about_blocks_timeline" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_timeline_path_idx" ON "about_blocks_timeline" USING btree ("_path");
  CREATE INDEX "about_blocks_skills_categories_order_idx" ON "about_blocks_skills_categories" USING btree ("_order");
  CREATE INDEX "about_blocks_skills_categories_parent_id_idx" ON "about_blocks_skills_categories" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_skills_order_idx" ON "about_blocks_skills" USING btree ("_order");
  CREATE INDEX "about_blocks_skills_parent_id_idx" ON "about_blocks_skills" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_skills_path_idx" ON "about_blocks_skills" USING btree ("_path");
  CREATE INDEX "about_blocks_beyond_code_paragraphs_order_idx" ON "about_blocks_beyond_code_paragraphs" USING btree ("_order");
  CREATE INDEX "about_blocks_beyond_code_paragraphs_parent_id_idx" ON "about_blocks_beyond_code_paragraphs" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_beyond_code_order_idx" ON "about_blocks_beyond_code" USING btree ("_order");
  CREATE INDEX "about_blocks_beyond_code_parent_id_idx" ON "about_blocks_beyond_code" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_beyond_code_path_idx" ON "about_blocks_beyond_code" USING btree ("_path");
  CREATE INDEX "about_blocks_certifications_items_order_idx" ON "about_blocks_certifications_items" USING btree ("_order");
  CREATE INDEX "about_blocks_certifications_items_parent_id_idx" ON "about_blocks_certifications_items" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_certifications_order_idx" ON "about_blocks_certifications" USING btree ("_order");
  CREATE INDEX "about_blocks_certifications_parent_id_idx" ON "about_blocks_certifications" USING btree ("_parent_id");
  CREATE INDEX "about_blocks_certifications_path_idx" ON "about_blocks_certifications" USING btree ("_path");
  CREATE INDEX "home_blocks_home_hero_order_idx" ON "home_blocks_home_hero" USING btree ("_order");
  CREATE INDEX "home_blocks_home_hero_parent_id_idx" ON "home_blocks_home_hero" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_home_hero_path_idx" ON "home_blocks_home_hero" USING btree ("_path");
  CREATE INDEX "home_blocks_pain_points_items_order_idx" ON "home_blocks_pain_points_items" USING btree ("_order");
  CREATE INDEX "home_blocks_pain_points_items_parent_id_idx" ON "home_blocks_pain_points_items" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_pain_points_order_idx" ON "home_blocks_pain_points" USING btree ("_order");
  CREATE INDEX "home_blocks_pain_points_parent_id_idx" ON "home_blocks_pain_points" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_pain_points_path_idx" ON "home_blocks_pain_points" USING btree ("_path");
  CREATE INDEX "home_blocks_mini_stack_items_order_idx" ON "home_blocks_mini_stack_items" USING btree ("_order");
  CREATE INDEX "home_blocks_mini_stack_items_parent_id_idx" ON "home_blocks_mini_stack_items" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_mini_stack_order_idx" ON "home_blocks_mini_stack" USING btree ("_order");
  CREATE INDEX "home_blocks_mini_stack_parent_id_idx" ON "home_blocks_mini_stack" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_mini_stack_path_idx" ON "home_blocks_mini_stack" USING btree ("_path");
  ...
  CREATE INDEX "home_blocks_works_order_idx" ON "home_blocks_works" USING btree ("_order");
  CREATE INDEX "home_blocks_works_parent_id_idx" ON "home_blocks_works" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_works_path_idx" ON "home_blocks_works" USING btree ("_path");
  ...
  CREATE INDEX "home_blocks_industries_order_idx" ON "home_blocks_industries" USING btree ("_order");
  CREATE INDEX "home_blocks_industries_parent_id_idx" ON "home_blocks_industries" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_industries_path_idx" ON "home_blocks_industries" USING btree ("_path");
  CREATE INDEX "home_blocks_process_phases_tags_order_idx" ON "home_blocks_process_phases_tags" USING btree ("_order");
  CREATE INDEX "home_blocks_process_phases_tags_parent_id_idx" ON "home_blocks_process_phases_tags" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_process_phases_order_idx" ON "home_blocks_process_phases" USING btree ("_order");
  CREATE INDEX "home_blocks_process_phases_parent_id_idx" ON "home_blocks_process_phases" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_process_order_idx" ON "home_blocks_process" USING btree ("_order");
  CREATE INDEX "home_blocks_process_parent_id_idx" ON "home_blocks_process" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_process_path_idx" ON "home_blocks_process" USING btree ("_path");
  ...
  CREATE INDEX "home_blocks_insights_order_idx" ON "home_blocks_insights" USING btree ("_order");
  CREATE INDEX "home_blocks_insights_parent_id_idx" ON "home_blocks_insights" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_insights_path_idx" ON "home_blocks_insights" USING btree ("_path");
  CREATE INDEX "home_blocks_page_cta_order_idx" ON "home_blocks_page_cta" USING btree ("_order");
  CREATE INDEX "home_blocks_page_cta_parent_id_idx" ON "home_blocks_page_cta" USING btree ("_parent_id");
  CREATE INDEX "home_blocks_page_cta_path_idx" ON "home_blocks_page_cta" USING btree ("_path");
  ...
  CREATE INDEX "speaking_talks_order_idx" ON "speaking_talks" USING btree ("_order");
  CREATE INDEX "speaking_talks_parent_id_idx" ON "speaking_talks" USING btree ("_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_settings_terminal_lines" CASCADE;
  ...
  DROP TABLE "about_blocks_about_hero_stats" CASCADE;
  DROP TABLE "about_blocks_about_hero" CASCADE;
  DROP TABLE "about_blocks_origin_story" CASCADE;
  DROP TABLE "about_blocks_philosophy_values" CASCADE;
  DROP TABLE "about_blocks_philosophy" CASCADE;
  DROP TABLE "about_blocks_timeline_items" CASCADE;
  DROP TABLE "about_blocks_timeline" CASCADE;
  DROP TABLE "about_blocks_skills_categories" CASCADE;
  DROP TABLE "about_blocks_skills" CASCADE;
  DROP TABLE "about_blocks_beyond_code_paragraphs" CASCADE;
  DROP TABLE "about_blocks_beyond_code" CASCADE;
  DROP TABLE "about_blocks_certifications_items" CASCADE;
  DROP TABLE "about_blocks_certifications" CASCADE;
  DROP TABLE "about" CASCADE;
  DROP TABLE "home_blocks_home_hero" CASCADE;
  DROP TABLE "home_blocks_pain_points_items" CASCADE;
  DROP TABLE "home_blocks_pain_points" CASCADE;
  DROP TABLE "home_blocks_mini_stack_items" CASCADE;
  DROP TABLE "home_blocks_mini_stack" CASCADE;
  DROP TABLE "home_blocks_about" CASCADE;
  DROP TABLE "home_blocks_works" CASCADE;
  DROP TABLE "home_blocks_services" CASCADE;
  DROP TABLE "home_blocks_industries" CASCADE;
  DROP TABLE "home_blocks_process_phases_tags" CASCADE;
  DROP TABLE "home_blocks_process_phases" CASCADE;
  DROP TABLE "home_blocks_process" CASCADE;
  DROP TABLE "home_blocks_testimonials" CASCADE;
  DROP TABLE "home_blocks_insights" CASCADE;
  DROP TABLE "home_blocks_page_cta" CASCADE;
  ...
  DROP TABLE "speaking_talks" CASCADE;
  DROP TABLE "speaking" CASCADE;
